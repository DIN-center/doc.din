...
curl <ENDPOINT> \
  ...
  -d '{"jsonrpc": "2.0", "method": "debug_traceBlockByNumber", "params": ["0x1b4", {"tracer": "callTracer"}], "id": 1}'
```
...
```bash
wscat -c <ENDPOINT> -x '{"jsonrpc": "2.0", "method": "debug_traceBlockByNumber", "params": ["0x1b4", {"tracer": "callTracer"}], "id": 1}'
```
