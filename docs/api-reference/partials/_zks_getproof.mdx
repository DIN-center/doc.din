...
- `address`: (string) _[required]_ - The account to fetch storage values and proofs for.
- `keys`: _[required]_ - Vector of storage keys in the account.
- `l1BatchNumber`: (number) _[required]_ - Number of the L1 batch specifying the point in time at which the requested values are returned.
...
```bash
wscat -c <ENDPOINT> -x '{"jsonrpc": "2.0", "id": 1, "method": "zks_getProof", "params": ["0x0000000000000000000000000000000000008003", ["0x8b65c0cf1012ea9f393197eb24619fd814379b298b238285649e14f936a5eb12"], 354895]}'
```
