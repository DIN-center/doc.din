...
description: "Returns the minimum balance (in lamports) required to make an account exempt from rent."
slug: /api-reference/solana/getminimumbalanceforrentexemption
---
