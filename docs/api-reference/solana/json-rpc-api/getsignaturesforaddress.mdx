...
description: "Returns signatures for confirmed transactions that include the specified address in the `accountKeys` list."
slug: /api-reference/solana/getsignaturesforaddress
---
