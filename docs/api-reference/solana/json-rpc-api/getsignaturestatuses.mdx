...
description: "Returns the statuses of a list of signatures. Unless the `searchTransactionHistory` configuration parameter"
slug: /api-reference/solana/getsignaturestatuses
---
