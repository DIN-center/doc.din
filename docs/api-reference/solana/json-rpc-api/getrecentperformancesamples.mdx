...
description: "Returns a list of recent performance samples, in reverse slot order. Performance samples are taken every 60 seconds"
slug: /api-reference/solana/getrecentperformancesamples
---
